...
def generate_video():
    ...
    font_path=font_path, logo_top_text=level, logo_top_text_color=level_color[level], logo_path=logo_path, logo_size=300, font_size=50, bottom_offset=500)
...
question_label.pack()
question_text = tk.Text(root, height=5, width=50, padx=20, pady=20)
question_text.pack()
